...
EOT;
        ...
        ?>
            ...
            <div class="container">
                <h3 class="jumbotron-heading">Hoa dành cho lễ cưới</h3>
                <p>
                Bạn đang tìm một bó hoa cưới thật đẹp trong ngày trọng đại của mình? Hãy để shop hoa tươi thay bạn thiết kế món quà dành cho ngày đặc biệt này của bạn. Hãy tin tưởng và giao trọng trách đem đến một bó hoa cưới cho shop hoa tươi của chúng tôi.
                </p>
            </div>
            </section>
