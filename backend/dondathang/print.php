...
SELECT 
    ddh.dh_ma, ddh.dh_ngaylap, ddh.dh_ngaygiao, ddh.dh_noigiao, ddh.dh_trangthai, httt.httt_ten, kh.kh_ten, kh.kh_dienthoai
...
GROUP BY ddh.dh_ma, ddh.dh_ngaylap, ddh.dh_ngaygiao, ddh.dh_noigiao, ddh.dh_trangthai, httt.httt_ten, kh.kh_ten, kh.kh_dienthoai
EOT;
...
EOT;
    ...
    <section class="sheet padding-10mm">
        ...
        <table border="0" width="100%" cellspacing="0">
            <tbody>
                <tr>
                    <td align="center"><img src="/shophoatuoi/assets/shared/img/logo.png" width="100px" height="100px" /></td>
                    <td align="center">
                        <b style="font-size: 2em;">Shop hoa tươi</b><br />
                        <small>Cung cấp các loại hoa theo nhiều chủ đề: sinh nhật, hoa cưới, chúc mừng,...</small><br />
                        <small>Giúp các bạn trao yêu thương đến người mình quan tâm.</small>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <small><i><?= $sanpham['ncc_ten'] ?></i></small>
                    </td>
