    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <br />
                <img src="/shophoatuoi/assets/shared/img/<?= $hinhsanphamRow['hsp_tentaptin'] ?>" class="img-fluid" width="300px" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <img src="/shophoatuoi/assets/shared/img/default.png" id="preview-img" width="200px" />
                </div>
            ...
            <?php 
                ...
                if (isset($_POST['btnSave'])) {
                    ...
                    $upload_dir = __DIR__ . "/../../assets/shared/";
