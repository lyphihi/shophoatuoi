    ...
    <div class="container">
        <div class="row">
            ...
            <form name="frmsanpham" id="frmsanpham" method="post" action="">
                    ...
                    <div class="form-group">
                        <label for="sp_motangan">Mô tả ngắn</label>
                        <input type="text" class="form-control" id="sp_motangan" name="sp_motangan" placeholder="Mô tả ngắn Sản phẩm" value="">
                    </div>
                    <div class="form-group">
                ...
                if (isset($_POST['btnSave'])) {
                    ...
                    // Câu lệnh INSERT
                    $sql = "INSERT INTO `sanpham` (sp_ten, sp_gia, sp_giacu, sp_motangan, sp_mota_chitiet, sp_ngaycapnhat, sp_soluong, lsp_ma, ncc_ma, km_ma) VALUES ('$ten', $gia, $giacu, '$motangan', '$motachitiet', '$ngaycapnhat', $soluong, $lsp_ma, $ncc_ma, $km_ma);";
                    // Thực thi INSERT
