...
<head>
    ...
    <link href="/duanweb/assets/frontend/css/style.css" type="text/css" rel="stylesheet" />
</head>
    ...
    <main role="main" class="mb-2">
        ...
        <div class="container mt-2">
            ...
            <div class="row">
                <div class="col col-md-6">
                    <img src="/duanweb/assets/frontend/img/marketing-1.png" class="img-fluid" />
                </div>
                <div class="col col-md-6">
        ...
        if (isset($_POST['btnGoiLoiNhan'])) {
            ...
            try {
                ...
                $mail->Username = 'thub1706651@student.ctu.edu.vn'; // SMTP username
                $mail->Password = 'egwabmtmsxjlhusj';                   // SMTP password
                ...
                //Recipients
                $mail->setFrom('thub1706651@student.ctu.edu.vn', 'Mail Liên hệ');
                $mail->addAddress('thub1706651@student.ctu.edu.vn');               // Add a recipient
