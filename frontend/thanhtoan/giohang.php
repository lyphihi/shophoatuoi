                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (empty($sanpham['hinhdaidien'])) : ?>
                                                <img src="/shophoatuoi/assets/shared/img/default.png" class="img-fluid hinhdaidien" />
                                            <?php else : ?>
                                                <img src="/shophoatuoi/assets/shared/img/<?= $sanpham['hinhdaidien'] ?>" class="img-fluid hinhdaidien" />
                                            <?php endif; ?>
                                        </td>
